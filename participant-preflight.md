...
learning objective — every optional step has an equivalent path.

**Logistics.** Join the meeting link in the invite a few minutes early. We will use breakout
rooms of three or four for activities, so please join from a device where you can browse and
talk at the same time. There is a 15-minute break in the middle and we will finish on time.

**One rule.** Everything we use is fictional: a made-up outdoor gear retailer and synthetic
customer messages. Please do not paste real customer messages, personal data, credentials, or
confidential material into any chat window during the session.
...
**Logistics.** We will sit at tables of four to six and work in small groups. Please arrive a
few minutes early so we can start on time. There is a 15-minute break in the middle and we will
finish on time. Bring a charger; guest network details will be on the screen.
...
## Checklist version (for a chat message or a slide)

- [ ] GitHub account, signed in on a browser
...
## Facilitator notes on this preflight
